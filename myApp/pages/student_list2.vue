            ...
            <template v-slot:append>
              <div class="d-flex flex-column align-end">
                ...
                <div class="text-grey-darken-1 text-caption mb-1">
                  {{ item.attendanceOptions }}
                  <span v-if="item.attendance !== undefined" class="ml-2"
...
const updateAttendance = (index, value) => {
  ...
  const payload = {
    studentName: activities.username,
    student_id: activities.student_id,
    attendance: value,
    time: activities.password,
  };
